...
class ReplicaDataset(GradSLAMDataset):
    def __init__(
        ...
        **kwargs,
        ...
        # self.pose_path = osp.join("/home/honsen/honsen", 'pose_left.txt')
        super().__init__(
            config_dict,
            stride=stride,
            start=start,
    ...
    def get_filepaths(self):
        # color_paths = sorted(glob.glob(osp.join("/home/honsen/honsen/DROID-SLAM-main/dataset/abandonedfactory_Easy_image_left/abandonedfactory/Easy/P000", 'image_left/*.png')))
        # depth_paths = sorted(glob.glob(osp.join("/home/honsen/honsen/DROID-SLAM-main/dataset/abandonedfactory_Easy_image_left/abandonedfactory/Easy/P000", 'depth_left/*.npy')))
